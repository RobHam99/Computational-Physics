...
x20 = np.array([-0.05, 0, 0])
v20 = np.array([0, 10., 0])

# Initial conditions Star 2
x30 = np.array([0.05, 0, 0])
v30 = np.array([0, -10., 0])
...
func = multi_body_verlet(f, [x10, x20, x30], [v10, v20, v30], t0, t1, h, [m1, m2, m3], 'data/task_4ii.csv')
...
df = pd.read_csv('data/task_4ii.csv', header=None)

fig, ((ax1)) = plt.subplots(1, 1)
ax1.plot(df.iloc[:50001, 1], df.iloc[:50001, 2], 'r-', label='x1')
ax1.plot(df.iloc[:50001, 7], df.iloc[:50001, 8], 'g-', label='x2')
ax1.plot(df.iloc[:50001, 13], df.iloc[:50001, 14], 'b-', label='x3')
