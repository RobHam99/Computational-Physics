...
x20 = np.array([-5., 0, 0])
v20 = np.array([0, 0.9, 0])

# Initial conditions Star 2
x30 = np.array([5., 0, 0])
v30 = np.array([0, -0.9, 0])

x = np.array([x10, x20, x30])
v = np.array([v10, v20, v30])
m = np.array([m1, m2, m3])
...
func = multi_body_verlet(f, x, v, t0, t1, h, m, 'data/task_4iv.csv')
...
df = pd.read_csv('data/task_4iv.csv', header=None)

# use df.iloc[5000001:, {column index}] for t0=50 t1=90 plot
